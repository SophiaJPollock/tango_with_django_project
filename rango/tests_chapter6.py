...
class Chapter6IndexViewTests(TestCase):
    ...
    def test_index_pages(self):
        ...
        for expected_regex in expected_pages_li:
            print(self.content)
            self.assertTrue(re.search(expected_regex, self.content), f"{FAILURE_HEADER}Checks for the top five pages in the index() view's response failed. Check you are using the correct list of objects, the correct HTML markup, and try again.{expected_pages_li} '{expected_regex}'{FAILURE_FOOTER}")
